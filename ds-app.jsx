...
function Rail({ tweaksOpen, setTweaksOpen }) {
  ...
  return (
    <div className="rail">
      <div className="rail-logo"><img src="assets/dreamstudio-icon.png" alt="DreamStudio" width="22" height="22"/></div>
      {items.map(it => (
    ...
    <div className="topbar">
      ...
      <div className="tb-right">
        ...
        <button className="ds-push-btn" onClick={onPush}>
          <span>Push to</span>
          <img src="assets/dreamfactory-logo.png" alt="DreamFactory" className="ds-push-logo"/>
        </button>
      </div>
    </div>
  );
