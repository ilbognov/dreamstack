...
(function () {
  ...
  const STOPS = [
    ...
    },
    {
      ...
      highlightPad: 4,
      anchor: "left",
      title: "Review — nothing ships without you."written\" and \"merged\" — and you hold the key.",
    },
    {
      id: "detail",
      requireRoute: "project",
      centered: true,
      title: "Open a card — full context in one place."why did you pick this type?\" or \"add a fraud-score threshold.\" The agent edits, re-runs tests, and brings it back for approval.",
      cta: "Open a card →",
      openCardAnim: true,
    },
    {
